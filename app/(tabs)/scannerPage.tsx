...
const styles = StyleSheet.create({
  ...
  detectedPlaceholder: { ...StyleSheet.absoluteFill, alignItems: 'center', justifyContent: 'center', backgroundColor: '#07101F', gap: 14 },
  ...
  resultCard: { ...StyleSheet.absoluteFill, paddingHorizontal: 28, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(2,6,23,0.86)' },
